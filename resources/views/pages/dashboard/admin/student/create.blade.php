...
<div class="container-fluid">
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-12 lg:px-8">
            <form action="{{ route('dashboard.student.store') }}" class="w-full" method="POST"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 mb-3">
                        ...
                        <input type="text" value="{{ old('nis') }}" name="nis"
                ...
                <div class="form-group row">
                    <div class="col-sm-6 mb-3">
                        <label for="" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Tempat
                            Lahir</label>
                        <input type="text" value="{{ old('born_place') }}" name="born_place"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 mb-3">
                        ...
                        <input type="text" value="{{ old('religion') }}" name="religion"
                ...
                <div class="form-group row">
                    <div class="col-sm-6 mb-3">
                        ...
                        <input type="text" value="{{ old('status') }}" name="status"
                    ...
                    <div class="col-sm-6 mb-3">
                        <label for="" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Anak
                            Ke-</label>
                        <input type="text" value="{{ old('siblings') }}" name="siblings"
                ...
                <div class="form-group row">
                    <div class="col-sm-12 mb-3">
                        <label for="" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Tanggal
                            diterima</label>
                        <input type="date" value="{{ old('accepted_date') }}" name="accepted_date"
                ...
                <div class="form-group row">
                    <div class="col-sm-6 mb-3">
                        <label for="" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Nama
                            Ayah</label>
                        <input type="text" value="{{ old('father') }}" name="father"
                            class="form-control form-control-user" placeholder="Nama Ayah" id="">
                    </div>
                    <div class="col-sm-6 mb-3">
                        <label for="" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Nama
                            Ibu</label>
                        <input type="text" value="{{ old('mother') }}" name="mother"
                ...
                <div class="form-group row">
                    <div class="col-sm-6 mb-3">
                        <label for=""
                            ...
                            Ayah</label>
                        <input type="text" value="{{ old('father_jobs') }}" name="father_jobs"
                    ...
                    <div class="col-sm-6 mb-3">
                        <label for=""
                            class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Pekerjaan
                            Ibu</label>
                        <input type="text" value="{{ old('mother_jobs') }}" name="mother_jobs"
                ...
                <div class="form-group row">
                    <div class="col-sm-6 mb-3">
                        <label for="" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Nama
                            Wali</label>
                        <input type="text" value="{{ old('caregiver') }}" name="caregiver"
                    ...
                    <div class="col-sm-6 mb-3">
                        <label for=""
                            class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Pekerjaan
                            Wali</label>
                        <input type="text" value="{{ old('caregiver_jobs') }}" name="caregiver_jobs"
                ...
                <div class="form-group row">
                    <div class="col-sm-12 mb-3">
                        <label for="" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Alamat
                            Wali</label>
                        <input type="text" value="{{ old('caregiver_address') }}"
                ...
                <div class="form-group row">
                    <div class="col-sm-12 mb-3">
                        ...
                        <input type="file" value="{{ old('url') }}" name="url"
