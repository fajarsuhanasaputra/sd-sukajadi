                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select name="mengajar" class="form-control @error('mengajar') is-invalid @enderror">
                                            ...
                                            <option value="TEMATIK" {{$pengajar->userDetail->mengajar == 'TEMATIK' ? 'selected' : ''}} >TEMATIK</option>
                                            <option value="TEMATIK2" {{$pengajar->userDetail->mengajar == 'TEMATIK2' ? 'selected' : ''}} >TEMATIK2</option>
                                            <option value="TEMATIK3" {{$pengajar->userDetail->mengajar == 'TEMATIK3' ? 'selected' : ''}} >TEMATIK3</option>
                                            <option value="TEMATIK4" {{$pengajar->userDetail->mengajar == 'TEMATIK4' ? 'selected' : ''}} >TEMATIK4</option>
                                        </select>
                                        @error('mengajar')
                                            <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
