        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action=" {{route('backend-pengajar.store')}} " method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select name="mengajar" class="form-control @error('mengajar') is-invalid @enderror">
                                            ...
                                            <option value="TEMATIK2">TEMATIK2<option>
                                            <option value="TEMATIK3">TEMATIK3<option>
                                            <option value="TEMATIK4">TEMATIK4<option>
                                        </select>
                                        @error('mengajar')
                                            <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
