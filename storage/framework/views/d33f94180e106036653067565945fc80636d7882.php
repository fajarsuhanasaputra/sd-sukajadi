            ...
            <div class="client-items text-center">
                <div class="row">
                    <div class="col-lg-3 col-md-6 item">
                        <div class="fun-fact">
                            <div class="timer" data-to="<?php echo e($teachers); ?>" data-speed="5000"><?php echo e($teachers); ?></div>
                            <span class="medium">Guru</span>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 item">
                        <div class="fun-fact">
                            <div class="timer" data-to="<?php echo e($students); ?>" data-speed="5000"><?php echo e($students); ?></div>
                            <span class="medium">Murid</span>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 item">
                        <div class="fun-fact">
                            <div class="timer" data-to="<?php echo e($rooms); ?>" data-speed="5000"><?php echo e($rooms); ?></div>
                            <span class="medium">Kelas</span>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 item">
                        <div class="fun-fact">
                            <div class="timer" data-to="<?php echo e($alumnus); ?>" data-speed="5000"><?php echo e($alumnus); ?></div>
            ...
            <div class="row align-center">
                ...
                <div class="col-lg-6 info wow fadeInUp">
                    ...
                    <div class="content">
                        ...
                        <a class="btn circle btn-theme border btn-sm" href="<?php echo e(route('about')); ?>">Read More <i class="fas fa-long-arrow-alt-right"></i></a>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="single-item col-lg-4 col-md-6">
                    <div class="item wow fadeInUp" data-wow-delay="600ms">
                        <div class="thumb">
                            <a href="#"><img src="<?php echo e($blog->galleries()->exists() ? Storage::url($blog->galleries->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=='); ?>"
                        ...
                        <div class="info">
                            ...
                            <a class="btn circle btn-theme border btn-sm" href="<?php echo e(route('details', $blog->slug)); ?>">Read More <i class="fas fa-long-arrow-alt-right"></i></a>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.landingpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Al-Hidayah\Documents\fina\sd-sukajadi\resources\views/pages/landingpage/index.blade.php ENDPATH**/ ?>