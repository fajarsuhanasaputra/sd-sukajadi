<!-- Start Footer 
============================================= -->
<footer class="bg-dark text-light" id="kontak">
    <div class="svg-shape">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 item">
                    <div class="f-item about">
                        <img src="<?php echo e(url('/landingPage/assets/img/mi.png')); ?>" alt="Logo">
                        <div class="address">
                            <ul>
                                <li>
                                    <div class="icon">
                ...
                <div class="col-lg-2 col-md-6 item">
                    <div class="f-item link">
                        <h4 class="widget-title">Lembaga</h4>
                        <ul>
                            <li>
                                <a href="#">Home</a>
                            </li>
...
<!-- End Footer -->  <?php /**PATH C:\Users\Al-Hidayah\Documents\fina\sd-sukajadi\resources\views/components/landingPage/footer.blade.php ENDPATH**/ ?>