    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4">
                <!-- CHART-->
                <div class="card">
                    <img class="card-img-top" src="<?php echo e(url('/admin/images/snk.png')); ?>" alt="Card image cap">
                    <div class="card-body">
            ...
            <div class="col-md-6 col-lg-4">
                <!-- TOP CAMPAIGN-->
                <div class="card">
                    <img class="card-img-top" src="<?php echo e(url('/admin/images/informasi.png')); ?>" alt="Card image cap">
                    <div class="card-body">
            ...
            <div class="col-md-6 col-lg-4">
                <!-- CHART PERCENT-->
                <div class="card">
                    <img class="card-img-top" src="<?php echo e(url('/admin/images/alur.png')); ?>" alt="Card image cap">
                    <div class="card-body">
...
<?php echo $__env->make('layouts.siswa', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Al-Hidayah\Documents\fina\sd-sukajadi\resources\views/dashboard.blade.php ENDPATH**/ ?>