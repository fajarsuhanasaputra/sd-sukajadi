...
class BerkasMuridRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
          ...
          'ijazah'                  => 'required|mimes:jpg,jpeg,png,pdf|max:2048'
        ];
    }
    ...
    public function messages()
    {
      return [
        ...
        'rapor.required'                  => 'file tidak boleh kosong.',
        'rapor.mimes'                     => 'file hanya mendukung .jpg .jpeg .png atau pdf.',
        ...
        'ijazah.mimes'                    => 'File hanya mendukung .jpg .jpeg .png atau pdf.',
