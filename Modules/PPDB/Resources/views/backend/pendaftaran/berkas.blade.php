    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2>Form Pendaftaran PPDB SDN 3 SUKAJADI</h2>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <small class="text-danger">Surat Kelakuan Baik dari RT/RW Setempat.</small>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="basicInput">KTP Ayah</label>
                                        <input type="file" class="form-control @error('rapor') is-invalid @enderror" name="rapor" />
                                        <small class="text-danger">KTP Asli Ayah.</small>
                                        @error('rapor')
                                            <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                            </div>
